...
echo "  2. for Claude Cowork access, install the plugin once:"
echo "       /plugin marketplace add aktopus/aesb"
echo "       /plugin install aesb"
echo "  3. read $REPO_ROOT/README.md for the week-1 sequence"
echo ""
